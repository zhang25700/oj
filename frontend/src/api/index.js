...
export const submitCode = (data) => http.post("/submit", data, longRunningRequest);
export const runCode = (data) => http.post("/submit/run", data, longRunningRequest);
export const getMySubmissions = (params) => http.get("/submit/my/page", { params });
export const getSubmissionDetail = (id) => http.get(`/submit/${id}`, longRunningRequest);
